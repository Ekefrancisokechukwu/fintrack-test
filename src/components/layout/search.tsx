  ...
  return (
    <div>
      <div className="relative flex min-w-[2rem] items-center gap-x-0 ">
        <div
          className={cn(
            "w-[20rem] min-[562px]:block hidden  relative transition-all duration-100 ease-out",
        ...
        <button
          ...
          className={cn(
            ...
            isOpen
              ? "min-[562px]:-translate-x-[10rem] min-[562px]:opacity-0 min-[562px]:invisible min-[562px]:bg-transparent bg-neutral-100"
      ...
      <div
        className={cn(
          "absolute shadow-lg min-[562px]:hidden block left-0 w-full transition-all duration-300 bg-default top-full py-1 px-2",
          isOpen
